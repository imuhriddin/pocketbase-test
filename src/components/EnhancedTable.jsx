...
const rows = [
  createData(1, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7, 9),
  createData(2, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(3, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(4, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(5, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(6, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(6, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(6, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
  createData(6, "Cupcake", 305, 3.7, 67, 4.3, 5, 4, 5, 6, 7),
];
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        ...
        <TableContainer
          sx={{ maxHeight: 410, maxWidth: "1200px", overflowX: "auto" }}
        >
          <Table
            stickyHeader
            sx={{ minWidth: 1200 }}
                  ...
                  >
                    <TableCell padding="checkbox">
                      <Checkbox
                        ...
                        onClick={(event) => {
                          event.stopPropagation(); // qo'shiladi!
